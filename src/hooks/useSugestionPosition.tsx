...
const isSugestionPosition = (value: unknown): value is FabPosition => {
...
const useSugestionPosition = (storageKey: string) => {
  ...
  useEffect(() => {
    const loadPosition = async (): Promise<void> => {
      try {
        ...
        if (!isSugestionPosition(parsedValue)) return;
...
export default useSugestionPosition;